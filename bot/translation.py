...
class Translation(object):
    ...
    START_TEXT = """<b> ഹൈ ബ്രോ എന്റെ പേര് രമണൻ ഞാൻ all movies group യിൽ മാത്രമേ ഉപയോഗിക്കാൻ കഴിയൂ{}!!</b>
...
<b>Press /help to know about available commands🤪</b>"""    
    ...
    HELP_TEXT =കണ്ട ബട്ടൺ CLICK ചെയ്ത്  HELP ചോദിയ്ക്കാൻ ഇത് നിന്റെ വമ്പാടി തറവാട് അല്ല... കിട്ടുന്ന MOVIES DOWNLOAD ചെയ്തോണ്ട് പോയിക്കോണം... """
<b>😉How To Use Me!😉?</b>
